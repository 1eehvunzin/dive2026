...
export const companies: Company[] = [
  ...
  },
  {
    ...
    report: {
      ...
      finance:
        "2025년 매출 73억 원으로 성장 중이나 아직 영업적자 단계다. 대규모 설비 투자가 진행 중이어서 추가 자금조달이 예정되어 있으며, 손익분기점은 2027년으로 전망된다.",
    },
  },
  {
    id: "co-loop",
  ...
  },
  {
    ...
    report: {
      ...
      market:
        "VPP 및 분산에너지 시장은 재생에너지 확대와 함께 고성장하고 있다. 전력중개·수요반응 사업이 제도적으로 확대되며 시장 규모가 커지고 있다.",
      technology:
        "다수의 분산자원을 실시간 예측·제어하는 최적화 엔진과 정산 자동화 시스템을 보유했다. 예측 정확도가 정산 수익에 직접 기여한다.",
      team:
